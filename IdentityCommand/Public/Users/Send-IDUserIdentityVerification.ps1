...
# swagger schema) - only the operation's existence and one-line summary ("Send
# SendIdentityVerificationOTP to a specified user"). The -ID parameter/body shape is inferred
# purely by analogy with other single-user CDirectoryService operations and is unverified.
