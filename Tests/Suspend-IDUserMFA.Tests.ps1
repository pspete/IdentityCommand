        ...
        Context 'Input' {
            ...
            It 'sends request to expected endpoint' {
                ...
                Assert-MockCalled Invoke-IDRestMethod -ParameterFilter {
                    ...
                    $URI -eq 'https://somedomain.id.cyberark.cloud/CDirectoryService/ExemptUserFromMfa?id=1234'
            ...
            It 'sends request to expected endpoint when object with UUID is provided via pipe' {
                ...
                Assert-MockCalled Invoke-IDRestMethod -ParameterFilter {
                    ...
                    $URI -eq 'https://somedomain.id.cyberark.cloud/CDirectoryService/ExemptUserFromMfa?id=5678'
