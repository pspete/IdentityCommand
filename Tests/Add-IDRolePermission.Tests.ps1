Describe $($PSCommandPath -Replace '.Tests.ps1') {
    ...
    InModuleScope $(Split-Path (Split-Path (Split-Path -Parent $PSCommandPath) -Parent) -Leaf ) {
        ...
        BeforeEach {
            ...
            # Add-IDRolePermission calls Get-IDPermission in its BEGIN block, and both
            # that call and Add-IDRolePermission's own request now go through
        ...
        Context 'Input' {
            ...
            It 'sends request to expected endpoint' {
                ...
                Assert-MockCalled Invoke-IDRestMethod -ParameterFilter {
                    ...
                    $URI -eq 'https://SomeTenant.id.cyberark.cloud/Roles/AssignSuperRights'
            ...
            It 'uses expected method' {
                ...
                Assert-MockCalled Invoke-IDRestMethod -ParameterFilter {
                    ...
                    $URI -match 'AssignSuperRights' -and $Method -match 'Post'
