    ...
    InModuleScope $(Split-Path (Split-Path (Split-Path -Parent $PSCommandPath) -Parent) -Leaf ) {
        ...
        Context 'Input' {
            ...
            BeforeEach {
                ...
                $response = Test-IDUserCloudLock -id 1234
            ...
            It 'sends request to expected endpoint' {
                ...
                Assert-MockCalled Invoke-IDRestMethod -ParameterFilter {
                    ...
                    $URI -eq 'https://somedomain.id.cyberark.cloud/UserMgmt/IsUserCloudLocked?id=1234'
            ...
            It 'sends request to expected endpoint when object with UUID is provided via pipe' {
                ...
                Assert-MockCalled Invoke-IDRestMethod -ParameterFilter {
                    ...
                    $URI -eq 'https://somedomain.id.cyberark.cloud/UserMgmt/IsUserCloudLocked?id=5678'
