    ...
    InModuleScope $(Split-Path (Split-Path (Split-Path -Parent $PSCommandPath) -Parent) -Leaf ) {
        ...
        Context 'NotFilled' {
            ...
            BeforeEach {
                ...
                $response = Get-IDAuthenticationAssuranceLevel -FirstFactorChallenges 'OTP'
            }
            ...
            It 'sends request to expected endpoint' {
                ...
                Assert-MockCalled Invoke-IDRestMethod -ParameterFilter {
                    ...
                    $URI -eq 'https://somedomain.id.cyberark.cloud/AuthProfile/GetProfileMFAScoring'
            ...
            It 'sends request with expected body' {
                ...
                Assert-MockCalled Invoke-IDRestMethod -ParameterFilter {
                    $($Body | ConvertFrom-Json | Select-Object -ExpandProperty Challenges) -contains 'OTP'
                } -Times 1 -Exactly -Scope It
