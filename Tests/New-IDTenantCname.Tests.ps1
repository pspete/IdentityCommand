    ...
    InModuleScope $(Split-Path (Split-Path (Split-Path -Parent $PSCommandPath) -Parent) -Leaf ) {
        ...
        Context 'Input' {
            ...
            BeforeEach {
                ...
                $response = New-IDTenantCname -cnamePrefix 'somecname'
            ...
            It 'sends request to expected endpoint' {
                ...
                Assert-MockCalled Invoke-IDRestMethod -ParameterFilter {
                    ...
                    ([system.uri]::new($URI) | Select-Object -ExpandProperty AbsolutePath) -match '/TenantCnames/Register'

                } -Times 1 -Exactly -Scope It

                Assert-MockCalled Invoke-IDRestMethod -ParameterFilter {

                    ([system.uri]::new($URI) | Select-Object -ExpandProperty query) -match 'cnamePrefix=somecname'
