Describe $($PSCommandPath -Replace '.Tests.ps1') {
    ...
    InModuleScope $(Split-Path (Split-Path (Split-Path -Parent $PSCommandPath) -Parent) -Leaf ) {
        ...
        BeforeEach {
            ...
            $response = Submit-UsersCsvUpload -ReturnID 'somereturnid' -AdminEmail 'admin@example.com' -SendEmailInvite
        ...
        Context 'Input' {
            ...
            It 'sends request to expected endpoint' {
                ...
                Assert-MockCalled Invoke-IDRestMethod -ParameterFilter {
                    ...
                    $URI -eq 'https://somedomain.id.cyberark.cloud/CDirectoryService/SubmitUploadedFile?importType=ImportBulkUser'
