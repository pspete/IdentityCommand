Describe $($PSCommandPath -Replace '.Tests.ps1') {
    ...
    InModuleScope $(Split-Path (Split-Path (Split-Path -Parent $PSCommandPath) -Parent) -Leaf ) {
        ...
        BeforeEach {
            ...
            $response = Get-IDRoleApplication -Name 'SomeRole'
        ...
        Context 'Input' {
            ...
            It 'sends request to expected endpoint' {
                ...
                Assert-MockCalled Invoke-IDRestMethod -ParameterFilter {
                    ...
                    ([system.uri]::new($URI) | Select-Object -ExpandProperty AbsolutePath) -match '/SaasManage/GetRoleApps'

                } -Times 1 -Exactly -Scope It

                Assert-MockCalled Invoke-IDRestMethod -ParameterFilter {

                    ([system.uri]::new($URI) | Select-Object -ExpandProperty query) -match 'role=SomeRole'
