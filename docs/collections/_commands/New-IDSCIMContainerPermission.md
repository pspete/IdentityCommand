...
# New-IDSCIMContainerPermission

## SYNOPSIS
Create a SCIM Container Permission

## SYNTAX

```
New-IDSCIMContainerPermission [-Attributes] <Hashtable> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

## DESCRIPTION
Creates a new SCIM Container Permission (Safe membership) resource.
