...
```
Remove-IDRoleMember [-Name] <Object> [[-Users] <Array>] [[-Roles] <Array>] [[-Groups] <Array>]
 [<CommonParameters>]
```

## DESCRIPTION
Removes the specified users, roles, and/or groups from the membership of an existing role. Supply one or more of -Users, -Roles, or -Groups with the identifiers of the principals to remove; any parameter left unspecified is treated as empty.
