...
# New-IDSCIMPrivilegedData

## SYNOPSIS
Create SCIM Privileged Data

## SYNTAX

```
New-IDSCIMPrivilegedData [-Attributes] <Hashtable> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

## DESCRIPTION
Creates a new SCIM Privileged Data resource.
